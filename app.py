...
def return_key():
    ...
    global idd
    idd=list_directory[0][8:-4]
    #print("......"+idd+"..............")
       
    return send_file(filename, download_name=f"My_Key{idd}.pem", as_attachment=True)
...
def upload_key():
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            idd=file.filename[6:-4]
            return start_decryption(idd)
        return 'Invalid File Format !'
